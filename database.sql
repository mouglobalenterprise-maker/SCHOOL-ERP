-- ============================================================
-- EduManage Pro - Complete School ERP Database
-- Version: 1.0
-- Engine: MySQL 5.7+
-- ============================================================
...
-- ============================================================
-- TABLE: class_subjects (many-to-many)
-- ============================================================
...
CREATE TABLE `timetable` (
  ...
  `period`     TINYINT UNSIGNED NOT NULL COMMENT '1-8',
...
('admin',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'System Administrator', 'admin@school.edu', '2207000000', 'active'),
('TCH001', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, 'Mr. Smith',            'smith@school.edu', '2207100001', 'active'),
('TCH002', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, 'Mrs. Johnson',         'johnson@school.edu','2207100002', 'active'),
('TCH003', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, 'Mr. Diallo',           'diallo@school.edu', '2207100003', 'active'),
('STU001', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 3, 'John Doe',             NULL,                '2207000001', 'active'),
('STU002', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 3, 'Amara Okonkwo',        NULL,                '2207000003', 'active'),
('sec001', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 4, 'Ms. Adams',            'adams@school.edu',  '2207200001', 'active');

-- NOTE: All passwords above are hashed 'password' from Laravel's bcrypt.
-- For production run: password_hash('admin123', PASSWORD_BCRYPT)
-- The login.php uses password_verify() correctly.
...
(1,1,4),(1,1,5),(1,1,6),  -- Mr. Smith: Mathematics SS1,SS2,SS3
(2,2,4),(2,2,5),           -- Mrs. Johnson: English SS1,SS2
(3,3,1),(3,3,2);           -- Mr. Diallo: Biology JSS1,JSS2

-- Students
INSERT INTO `students`
  (`student_id`,`full_name`,`gender`,`dob`,`class_id`,`session_id`,`parent_name`,`parent_phone1`,`parent_phone2`,`address`,`status`,`enrolled_date`,`user_id`) VALUES
...
(1,4,1,'2025-04-09','present',2),
(2,5,1,'2025-04-09','absent', 2),
(3,1,1,'2025-04-09','late',   2),
(4,2,1,'2025-04-09','present',2),
(5,6,1,'2025-04-09','present',2),
(1,4,1,'2025-04-08','present',2),
(2,5,1,'2025-04-08','present',2),
(3,1,1,'2025-04-08','present',2),
(4,2,1,'2025-04-08','absent', 2),
(5,6,1,'2025-04-08','present',2);

-- Announcements
INSERT INTO `announcements` (`title`,`body`,`priority`,`target`,`posted_by`) VALUES
('End of Term Exams',     'End of term examinations begin April 20, 2025. All students must be present.','high',  'all',      1),
('Sports Day 2025',       'Annual sports day is scheduled for April 15. All classes to participate.',     'normal','all',      1),
('Fee Payment Reminder',  'Parents are reminded all outstanding fees must be cleared before exams.',      'high',  'parents',  7);
...
(2, 5, 'Test Results', 'Well done on your mathematics test, John. Keep it up!', 0, 0),
(1, NULL, 'Staff Meeting Friday', 'All staff are reminded of the meeting on Friday at 2PM in the conference room.', 1, 0);
